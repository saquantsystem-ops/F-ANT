...
from jesse.modes.import_candles_mode.drivers.AngelOne.AngelOne import AngelOne
from jesse.modes.import_candles_mode.drivers.YFinance.YFinanceDriver import YFinanceDriver
from jesse.modes.import_candles_mode.drivers.Excel import ExcelDriver
...
drivers = {
    ...
    # Angel One
    exchanges.ANGEL_ONE: AngelOne,
    # YFinance (Free data - Stocks, Crypto, Forex)
    exchanges.YFINANCE: YFinanceDriver,
    exchanges.EXCEL: ExcelDriver,
}
