...
def get_general_info(has_live=False) -> dict:
    ...
    if has_live:
        ...
        # MOCK live version since we don't have the plugin
        system_info['live_plugin_version'] = '0.0.1-mock'
        ...
        if access_token:
            ...
            try:
             ...
             # PROVIDE MOCK LIMITS TO PREVENT CRASH
             limits = {
                'ip_limit': 1000,
                'live_trading_tabs': 10,
                'trading_routes': 100,
                'data_routes': 100,
                'timeframes': jesse_supported_timeframes,
                'exchanges': exchange_info,
             }
             plan_info = {'plan': 'enterprise'}
